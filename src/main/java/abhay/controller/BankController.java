...
import abhay.repo.BankRepository;

@Controller
public class BankController 
{
	@Autowired
	BankRepository urepo;
	...
	@PostMapping("/addUser")
	public ModelAndView addUser(@RequestParam("user_email") String user_email, Bank user)
	{
		ModelAndView mv=new ModelAndView("success");
		List<Bank> list=urepo.findByEMAIL(user_email);
	...
	Bank auser=urepo.findByUsernamePassword(username, password);
